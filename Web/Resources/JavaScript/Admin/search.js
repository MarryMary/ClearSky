...
document.getElementById("search_del").addEventListener('keyup',function(){
    ...
    $.ajax('Search/Info',
    {
        ...
        data.Result.forEach(function (element) {
            $('#table').append('<tr><th scope="row">'+element[0]+'</th><td>'+ element[1] +'</td><td>'+element[3]+'</td><td><button type="button" class="btn btn-success">更新</button></td> <td><input class="form-check-input" type="checkbox" value="'+ element[0] +'" id="flexCheckDefault"></td></tr>');
        });
    });
});
 */
